...
function App() {
  ...
  const institute = ["IIT", "NIT", "Kerala University", "Pune University","CUCET"];
    ...
    <div className="relative">
      <div className="bg-[#D7DFDC] p-8 px-20 relative" style={{ backgroundColor: '#d71e28', borderBottom:'4px solid #ffcd41'}} > 
        <div className="flex items-center flex-row justify-between">
          <div className="text-3xl text-blue-700 font-bold tracking-tight" style={{ color:'whitesmoke' }}>
             CloudZone: Hackathon 2024 Resume Best Match Application
          </div>
        </div>
        <div className="w-full">
          ...
          <div className="mt-3 relative flex flex-row items-center bg-white w-3/5 p-3 pl-6 rounded-full ">
            ...
            <input
              ...
              placeholder="Drop your folder link..."
              type="text"
      ...
      <div className="flex flex-row mb-4 w-full justify-center">
        <div className=" h-full gap-2 w-4/6 grid grid-cols-3">
          {initial && (
            <p className="p-5 w-full text-center text-gray-500 py-20 items-center text-2xl justify-center flex col-span-4">
              Paste the drive folder link 🔗(Folder should be shared
              publicaly) set the parameters for the search.
            </p>
          )}
          {loading && (
